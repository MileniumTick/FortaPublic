...
const avatarPrecios = (id) => (
    <svg id={id} className="border border-collapse hover:animate-pulse border-slate-600 shadow-lg squared rounded-md shadow-slate-500 fill-current text-slate-600" width="35px" height="35px" viewBox="0 0 21 21" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className="lg:p-10 text-left flex lg:h-96 h-full mix-blend-hard-light lg:break-normal break-all">
                                    <ul className="max-w-max">
                                        ...
                                        <li className="flex items-center h-auto p-2">
                                            <svg className="min-w-max min-h-max max-h-5 max-w-5 text-green-600 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
